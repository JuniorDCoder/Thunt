        ...
        <div class="flex-row mt-24">
          <div class="flex flex-col w-1/2 gap-20">
            ...
            <p class="z-10 w-full text-2xl leading-10">At Thunt, we believe in the transformative power of education and the importance 
              of making quality tutoring accessible to all. Our
               mission is to bridge the gap between students and 
               tutors by providing a platform that is not only easy 
               to use but also rich in features that enhance student’s 
               learning experience and tutoring.
               Join Us on Our Journey
               Whether you are a student seeking support, a tutor looking to expand your reach, or a parent searching for reliable educational resources, Thunt is here to help. Join us on our journey to revolutionize the way tutoring is delivered and accessed.
